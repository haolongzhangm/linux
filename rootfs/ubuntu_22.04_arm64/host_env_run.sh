...
if [ -f ubuntu-base-22.04-base-arm64.tar.gz ];then
    echo "find ubuntu-base-22.04-base-arm64.tar.gz, do not download"
else
    wget http://cdimage.ubuntu.com/ubuntu-base/releases/22.04.2/release/ubuntu-base-22.04-base-arm64.tar.gz
fi

sudo tar -xvf ubuntu-base-22.04-base-arm64.tar.gz -C build
...
sudo rm build/dev/*
sudo LD_LIBRARY_PATH=./make_ext4fs_prebuild ./make_ext4fs_prebuild/make_ext4fs -l 10240M system.img build
